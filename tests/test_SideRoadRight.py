...
# Assuming SideRoadRight class has a method named load_image to load an image
@patch('pygame.image.load', return_value=MagicMock())
@pytest.mark.image_loading
def test_image_loading(mock_load):
    # Create a SideRoadRight instance
    side_road = SideRoadRight("../assets/img/sideroad.png", 800, 600)
...
@pytest.fixture
def side_road():
    return SideRoadRight("../assets/img/sideroad.png", 800, 600)
